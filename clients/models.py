...
class Clients(models.Model):
    ...
    date_rdv = models.DateField(null=True)
    heure_rdv = models.TimeField(null=True)
    date_contact = models.DateField(null=True)
    heure_contact = models.TimeField(null=True)
